...
export default {
  ...
  setup(){
    ...
    const time = computed(()=> store.getters.isTime4);
    const male = computed(()=> store.getters.isMale4);
    const female = computed(()=> store.getters.isFemale4);
    const all = computed(()=> store.getters.isAll4);
    const isShow = computed(()=> store.getters.isShow4);
    // const init = () => {
